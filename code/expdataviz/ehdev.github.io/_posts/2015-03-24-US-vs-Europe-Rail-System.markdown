...
![Here is the chart I am critiquing]({{ site.baseurl }}/assets/source_chart = 685x450)
...
<a href="/assets/grouped_all.png">({{ site.baseurl }}/assets/grouped_all.png = 685x450)</a>
...
({{ site.baseurl }}/assets/plots.png = 685x450)

and alternative visualizations:

<a href='/assets/alt_bar.png'>({{ site.baseurl }}/assets/alt_bar = 50x50)</a>
<a href='/assets/alt_line.png'>({{ site.baseurl }}/assets/alt_line = 50x50)</a>